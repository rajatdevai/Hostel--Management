...
function AccountSetupStep2({ formData, handleNextStep }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        handleNextStep({ designation, department, otherDetails });
    };
        ...
        <div className="flex flex-col items-start justify-center mt-8 max-h-screen mx-32">
            ...
            <form className="md:mt-8 mb-2 w-auto max-w-screen-lg md:w-full" onSubmit={handleSubmit}>
                <div className="mb-6">
                    ...
                    <Select options={tags1} multiple={true} value={designation} onChange={handleDesignationChange} />
                </div>
                <div className="mb-6">
                    <label className="text-white text-base font-medium mb-1">Department</label>
                    <Select options={getDepartmentOptions()} multiple={true} value={department} onChange={handleDepartmentChange} />
                </div>
                <div className="mb-6">
